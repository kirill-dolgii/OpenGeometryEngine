...
public class PlanarMinCycleSolverTests
{
    ...
    public void RECT_INTERSECTOIN_CYCLES()
    {
        ...
        //var p8 = new Point(0.005, 0.005, 0.0);
        //var p9 = new Point(0.015, 0.005, 0.0);
        //var p10 = new Point(0.015, 0.015, 0.0);
        //var p11 = new Point(0.005, 0.015, 0.0);

        //var p12 = new Point(0.006, 0.006, 0.0);
        //var p13 = new Point(0.014, 0.006, 0.0);
        //var p14 = new Point(0.014, 0.014, 0.0);
        //var p15 = new Point(0.006, 0.014, 0.0);
