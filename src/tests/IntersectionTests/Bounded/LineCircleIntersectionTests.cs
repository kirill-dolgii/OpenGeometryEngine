...
public class LineCircleIntersectionTests
{
    ...
    {
        var lineSegment = LineSegment.Create(Line.Create(new Point(-0.026, 0.009, 0), new Vector(0.8, 0.6, 0)), 
        ...
        var circleFrame = new Frame(new Point(-0.022, 0.004, 0),
                                    ...
                                    new Vector(0, 0, 1));
        var circleSegment = Arc.Create(Circle.Create(circleFrame, 0.0107703296143), new Interval(.0, 1.89891622181));
